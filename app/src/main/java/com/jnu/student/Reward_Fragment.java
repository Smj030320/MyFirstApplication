...
public class Reward_Fragment extends Fragment {
    ...
    public static Reward_Fragment newInstance() {
        Reward_Fragment fragment = new Reward_Fragment();
    ...
    public View onCreateView(LayoutInflater inflater, ViewGroup container,
        ...
        rewardRecyclerView = rootView.findViewById(R.id.Reward_Recycler_View);
